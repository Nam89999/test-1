  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">Panel Content
      <div class="form-group">
       <label>Bno</label>
    <input type="text" class="form-control" id="boardnum" name="boardnum" value="${boardInfo.boardnum}" readonly="readonly">
  </div>
    <label>Title</label>
    <input type="text" class="form-control" name="title" value="${boardInfo.title}" readonly="readonly">
  </div>
  <div class="form-group">
    <label>Text area</label>
	<textarea rows="3" class="form-control" name="contents" readonly="readonly">${boardInfo.contents}</textarea>
  </div>
  <div class="form-group">
    <label>writer</label>
